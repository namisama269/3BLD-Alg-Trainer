import {
  randomChoice
} from "./chunk-GEU222WG.js";
import {
  countMoves
} from "./chunk-YJYMNXSR.js";
import {
  cube2x2x2,
  from,
  puzzles
...
import {
  KPattern,
  KPuzzle
} from "./chunk-L35JARJK.js";
import {
  Alg,
  AlgBuilder,
  Move
} from "./chunk-JLLQZ372.js";
import {
  __publicField
} from "./chunk-WOOG5QLI.js";

// node_modules/cubing/dist/lib/cubing/chunks/chunk-ZQ3THAI5.js
...
var dynamic3x3x3min2phase = from(() => import("./search-dynamic-solve-3x3x3-QHRLSVAC-I74EFBQA.js"));
...
var searchDynamicSideEvents = from(() => import("./search-dynamic-sgs-side-events-PAMLOZFW-LQV6B66Y.js"));
var twsearchPromise = from(async () => import("./twsearch-QLSDT3QA-34E2F5P3.js"));
...
var dynamic4x4x4Solver = from(() => import("./search-dynamic-solve-4x4x4-NLEVMG3O-33CZYEWS.js"));
var randomSuffixes2 = [
  [null, "x", "x2", "x'", "z", "z'"],
  [null, "y", "y2", "y'"]
];
...
var dynamicFTOSolver = from(() => import("./search-dynamic-solve-fto-EY5ZVAGO-OVIJG6FK.js"));
var dynamic = from(() => import("./search-dynamic-sgs-unofficial-3Q5EC27G-DKIJLVXM.js"));
async function randomFTOScramble() {
  mustBeInsideWorker();
  return new Alg(await (await dynamicFTOSolver).randomFTOScrambleString());
}
var dynamicKilominxSolver = from(() => import("./search-dynamic-solve-kilominx-F7OMJSDE-5E72PI2U.js"));
async function randomKilominxScramble() {
  mustBeInsideWorker();
  return (await dynamicKilominxSolver).getRandomKilominxScramble();
}
var dynamicMasterTetraminxSolver = from(() => import("./search-dynamic-solve-master_tetraminx-3D4MBF3V-RYD32VFR.js"));
...
var searchDynamicUnofficial = from(() => import("./search-dynamic-sgs-unofficial-3Q5EC27G-DKIJLVXM.js"));
...
var dynamicSq1Solver = from(() => import("./search-dynamic-solve-sq1-NGOQHFV4-S54XKNXO.js"));
...
//# sourceMappingURL=chunk-ETSDXP4H.js.map
